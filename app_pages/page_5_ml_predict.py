...
def page_5_ml_predict_body():
    ...
    st.info(
        ...
        f"imrove this score further by using a Regressor model with PCA \n"
        f"A number of steps were taken to clean and prepare the data for the pipeline "
        f"which are outlined below. "
    )
